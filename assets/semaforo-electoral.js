...
;
          if (!runningTests) {
            require("semaforo-electoral/app")["default"].create({"name":"semaforo-electoral","version":"0.0.0+4eb2b1fa"});
          }
