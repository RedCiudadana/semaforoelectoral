...
define('semaforo-electoral/tests/integration/components/display-rules-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | display-rules', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "AhgW2ZD+",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"display-rules\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "Dkaqr2C9",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"display-rules\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('semaforo-electoral/tests/integration/helpers/get-color-stage-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Helper | getColorStage', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "YtTnZBUd",
        "block": "{\"symbols\":[],\"statements\":[[1,[27,\"get-color-stage\",[[23,[\"inputValue\"]]],null],false]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('semaforo-electoral/tests/integration/helpers/sum-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Helper | sum', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "l1otDQew",
        "block": "{\"symbols\":[],\"statements\":[[1,[27,\"sum\",[[23,[\"inputValue\"]]],null],false]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('semaforo-electoral/tests/lint/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/display-rules.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/display-rules.js should pass ESLint\n\n');
  });

  QUnit.test('helpers/get-color-stage.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'helpers/get-color-stage.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/index/despues.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/index/despues.js should pass ESLint\n\n');
  });

  QUnit.test('routes/index/durante.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/index/durante.js should pass ESLint\n\n');
  });

  QUnit.test('routes/index/previo.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/index/previo.js should pass ESLint\n\n');
  });
...
define('semaforo-electoral/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('semaforo-electoral/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'semaforo-electoral/templates/application.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('semaforo-electoral/templates/components/display-rules.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'semaforo-electoral/templates/components/display-rules.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('semaforo-electoral/templates/footer.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'semaforo-electoral/templates/footer.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('semaforo-electoral/templates/head.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'semaforo-electoral/templates/head.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('semaforo-electoral/templates/index.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'semaforo-electoral/templates/index.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('semaforo-electoral/templates/index/despues.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'semaforo-electoral/templates/index/despues.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('semaforo-electoral/templates/index/durante.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'semaforo-electoral/templates/index/durante.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('semaforo-electoral/templates/index/previo.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'semaforo-electoral/templates/index/previo.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('semaforo-electoral/templates/metodologia.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'semaforo-electoral/templates/metodologia.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('semaforo-electoral/templates/navbar.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'semaforo-electoral/templates/navbar.hbs should pass TemplateLint.\n\n');
  });
});
define('semaforo-electoral/tests/lint/tests.lint-test', [], function () {
  'use strict';

  QUnit.module('ESLint | tests');

  QUnit.test('integration/components/display-rules-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/display-rules-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/helpers/get-color-stage-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/helpers/get-color-stage-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/routes/index/despues-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/index/despues-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/index/durante-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/index/durante-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/index/previo-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/index/previo-test.js should pass ESLint\n\n');
  });
...
define('semaforo-electoral/tests/test-helper', ['semaforo-electoral/app', 'semaforo-electoral/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('semaforo-electoral/tests/unit/routes/index-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('semaforo-electoral/tests/unit/routes/index/despues-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | index/despues', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:index/despues');
      assert.ok(route);
    });
  });
});
define('semaforo-electoral/tests/unit/routes/index/durante-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | index/durante', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:index/durante');
      assert.ok(route);
    });
  });
});
define('semaforo-electoral/tests/unit/routes/index/previo-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | index/previo', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:index/previo');
      assert.ok(route);
    });
  });
});
define('semaforo-electoral/tests/unit/routes/metodologia-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | metodologia', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('semaforo-electoral/tests/unit/services/spreadsheets-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Service | spreadsheets', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    // Replace this with your real tests.
    (0, _qunit.test)('it exists', function (assert) {
      let service = this.owner.lookup('service:spreadsheets');
      assert.ok(service);
    });
  });
});
...
require('semaforo-electoral/tests/test-helper');
